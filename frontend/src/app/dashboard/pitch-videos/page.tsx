...
const FORMAT_ROWS: { field: string; desc: string }[] = [
  ...
  { field: "style", desc: '"minimal" (flat, editorial — the default) or "schematic" (animated precision-schematic look: glow accents, staged entrances, chapter chrome, scene motifs).' },
  { field: "scenes[].layout", desc: "hero · statement · stat-trio · two-column · architecture · bar-chart · timeline · team · close — the starter template shows one of each with its exact content shape. Schematic-native extras: split-reveal · verdict-lanes · card-grid · stack-summary · terms." },
  { field: "scenes[].chapter / emphasis / motif", desc: 'Schematic-style extras: chapter {num, label} shows the ghost numeral + eyebrow; emphasis is the exact headline/caption substring that gets the luminous underline sweep; motif ("stream" | "gate") adds the content-chip stream / scanning-gate backdrop to hero scenes.' },
